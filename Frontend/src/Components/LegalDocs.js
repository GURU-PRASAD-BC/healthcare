  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Health <span className="legal-siteSign">Assistant</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health Assistant, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Health Assistant, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Health Assistant is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2013-2023 Health Assistant. All rights reserved.</p>
      </div>
    </div>
  );
}
